...
def firstwin():
    ...
    l0 = Label(f1, text="Monthly Expenses Tracker", font=font1, bg="Black", fg="White")
    l0.place(x=320, y=45)
...
def addrec(addrec_button):
    ...
    Button(f3, cursor="hand2", command=lambda: clear(item_name, cost), text="Reset", fg='white', bg='#3895D3', border=4, font=("Roboto Mono", 14)).place(x=420, y=320)
